...
//base app code hash;
const ACL_APP_CODE_HASH: &str = "9CAEF843BF4DCE443111B72F67761A3F";
const VOTING_APP_CODE_HASH: &str = "F8175E1A6CE68CE356582106F13F7864";
const TOKEN_APP_CODE_HASH: &str = "F30D0FD36D78B08DB8349BEABE00E7A4";
